...
function UserApprovalContent() {
  ...
  useEffect(() => {
    // Demo: Kullanıcı başvuru verilerini yükle
    const loadApplication = async () => {
      setIsLoading(true);
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      // Demo veri
      const demoApplication: UserApplication = {
        id: userId || '1',
        name: 'Mehmet Demir',
        ...
        documents: {
          ...
          cv: 'cv_mehmet_demir.pdf',
          referenceLetter: 'referans_mektubu.pdf'
        }
      };
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push('/admin/users?status=approved');
      }, 2000);
    } catch (error) {
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      // Başarı mesajı ve yönlendirme
      setTimeout(() => {
        router.push('/admin/users?status=rejected');
      }, 2000);
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Aradığınız kullanıcı başvurusu bulunamadı.</p>
        ...
        <div className="px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Kullanıcı Onay İşlemi</h1>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900">{application.role}</p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">{application.restaurantName}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700">İşletme ID</label>
                    <p className="mt-1 text-sm text-gray-900 font-mono">{application.restaurantId}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                {application.documents.referenceLetter && (
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center">
                      <FaFileAlt className="mr-3 text-gray-400" />
                      <span className="text-sm font-medium text-gray-900">Referans Mektubu</span>
                    </div>
                    <button className="text-blue-600 hover:text-blue-800 text-sm flex items-center">
                      <FaFileAlt className="mr-1" />
                      Görüntüle
